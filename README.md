...
- 🛰️ **Passive BLE Scanning** – Discovers nearby BLE devices with signal strength (RSSI) and estimated distance
- 🏷️ **Device Info Extraction** – Retrieves local name, advertised service UUIDs, and manufacturer-specific data
- 🔐 **Privacy Heuristics**
...
- **M5Stack Cardputer** (primary target)
  ...
  - **⚠️ microSD card required** – the device halts on boot without one
...
2. **▶️ Start Scan** – Long press BtnA to begin BLE scanning
...
| 🔍 Check | ✅ Flag | Meaning |
|-----------|---------|---------|
| **Rotating** | ✅ | Device uses MAC address randomization (RPA) – good privacy practice |
| **Cleartext** | ❗ | Device advertises personal info in plain text – privacy risk |
...
- ✔️ **Not Cleartext**: The advertising data is encrypted or obfuscated
