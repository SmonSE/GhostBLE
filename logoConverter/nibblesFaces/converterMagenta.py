...
def convert_png_with_transparency(png_path, output_name="nibblesStartWorking"):
...
# Beispielaufruf
convert_png_with_transparency("nibbles_working_happy_bubble.png", output_name="nibblesStartWorking")
